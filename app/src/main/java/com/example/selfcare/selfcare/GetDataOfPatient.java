...
/////
    ...
    public ArrayList<String> alltemp(String Email){
        ...
        return  null;}
    public ArrayList<String> allhearts(String Email){
        ArrayList<String> press = new ArrayList<String>();
        String result= "" ;
        Cursor cc = sqlDB.query(TableData.CheckUP.TableNameCH, columnOfrecords, TableData.CheckUP.Patient_ID + "=?", new String[] { Email }, null, null, null);
        int i=0;
        ...
        return  null;}
    public ArrayList<String> allpressur(String Email){
        ArrayList<String> press = new ArrayList<String>();
        String result= "" ;
        Cursor cc = sqlDB.query(TableData.CheckUP.TableNameCH, columnOfrecords, TableData.CheckUP.Patient_ID + "=?", new String[] { Email }, null, null, null);
        int i=0;
