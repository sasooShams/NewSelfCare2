...
public class Get_sever_data_for_doctor {
    ...
    String column[] = new String[]{TableData.Doc_server_patients.Fname, TableData.Doc_server_patients.Lname,
            TableData.Doc_server_patients.Email, TableData.Doc_server_patients.Doctor_email,
    ...
    public ArrayList<String> allEmail(String Email){
        ArrayList<String> emails = new ArrayList<String>();
        Cursor cc = sqlDB.query(TableData.Doc_server_patients.doc_server_patients, column, TableData.Doc_server_patients.Doctor_email + "=?", new String[] { Email }, null, null, null);
       int i=0;
        if (cc.moveToFirst()){

            while (cc.isAfterLast() == false) {

                emails.add(i, cc.getString(2));
i++;
            cc.moveToNext();
            }
    ...
    public ArrayList<String> allfname(String Email){
        ArrayList<String> emails = new ArrayList<String>();
        Cursor cc = sqlDB.query(TableData.Doc_server_patients.doc_server_patients, column, TableData.Doc_server_patients.Doctor_email + "=?", new String[] { Email }, null, null, null);
        int i=0;
        if (cc.moveToFirst()){
    ...
    public ArrayList<String> alltemp(String Email){
        ArrayList<String> emails = new ArrayList<String>();
        Cursor cc = sqlDB.query(TableData.servr_CheckUP.doc_server_CheckUPs, columnOfrecords, TableData.servr_CheckUP.Patient_ID + "=?", new String[] { Email }, null, null, null);
        int i=0;
        if (cc.moveToFirst()){
    ...
    public ArrayList<String> allheart(String Email){
        ArrayList<String> emails = new ArrayList<String>();
        Cursor cc = sqlDB.query(TableData.servr_CheckUP.doc_server_CheckUPs, columnOfrecords, TableData.servr_CheckUP.Patient_ID + "=?", new String[] { Email }, null, null, null);
        int i=0;
        if (cc.moveToFirst()){
    ...
    public ArrayList<String> allpressure(String Email){
        ArrayList<String> emails = new ArrayList<String>();
        Cursor cc = sqlDB.query(TableData.servr_CheckUP.doc_server_CheckUPs, columnOfrecords, TableData.servr_CheckUP.Patient_ID + "=?", new String[] { Email }, null, null, null);
        int i=0;
        if (cc.moveToFirst()){
    ...
    public ArrayList<String> alltimes(String Email){
        ArrayList<String> emails = new ArrayList<String>();
        Cursor cc = sqlDB.query(TableData.servr_CheckUP.doc_server_CheckUPs, columnOfrecords, TableData.servr_CheckUP.Patient_ID + "=?", new String[] { Email }, null, null, null);
        int i=0;
        if (cc.moveToFirst()){
