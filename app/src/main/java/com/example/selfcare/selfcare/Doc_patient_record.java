...
public class Doc_patient_record extends AppCompatActivity {
    ListView lv;
    ListView lv2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String emails = sharedpreferences.getString("pemails", "null");
Toast.makeText(this,emails,Toast.LENGTH_LONG).show();
        ...
        hearts=getdata.allheart(emails);
        press=getdata.allpressure(emails);
    ...
    class CustomAdapter extends BaseAdapter {
        ...
        public CustomAdapter(Doc_patient_record mainActivity, String[] prgmNameList, String[] prgmNameList2, String[] prgmNameList3, String[] prgmNameList4) {
